;;; pallete-create-theme.el

;; This is a fork of solarized-theme by Bozhidar Batsov.
;; The color palette has been extracted, and various behaviors
;; have been changed to allow more flexibility in the creation
;; of other themes following these same rules.
;; In particular the decisions for coloring the modeline have
;; been changed.
;; The resulting solarized-dark2 and solarized-light2 are
;; similar, but different from the original solarized themes.
;; New themes can be created just by creating a new palette.
;; Author: Eric Gebhart <e.a.gebhart@gmail.com> 4/7/2014
...
(defun get-palette-color (colors name)
  (cdr (assoc name colors))
  )

(defun create-theme (variant theme-name palette &optional childtheme)
...
customize the resulting theme."
  (let* ((class '((class color) (min-colors 89)))
         ...
         (base03    (get-palette-color palette "base03"))
         (base02    (get-palette-color palette "base02"))
         ;; emphasized content
         (base01    (get-palette-color palette "base01") )
         ;; primary content
         (base00    (get-palette-color palette "base00") )
         (base0     (get-palette-color palette "base0") )
         ;; comments
         (base1     (get-palette-color palette "base1") )
         ;; background highlight light
         (base2     (get-palette-color palette "base2") )
         ;; background light
         (base3     (get-palette-color palette "base3") )
         ;; modeline active - if not defined, used fg, bg, and highlight.
         (base4     (get-palette-color palette "base4"))
         (base04    (get-palette-color palette "base04"))
         ;; modeline inactive
         (base5     (get-palette-color palette "base5"))
         (base05    (get-palette-color palette "base05"))
         ;; modeline foreground.
         (base6     (get-palette-color palette "base6"))
         (base06    (get-palette-color palette "base06"))


         ;; Solarized accented colors
         (yellow    (get-palette-color palette "yellow") )
         (orange    (get-palette-color palette "orange") )
         (red       (get-palette-color palette "red") )
         (magenta   (get-palette-color palette "magenta") )
         (violet    (get-palette-color palette "violet") )
         (blue      (get-palette-color palette "blue") )
         (cyan      (get-palette-color palette "cyan") )
         (green     (get-palette-color palette "green") )

         ;; Darker and lighter accented colors
         ;; Only use these in exceptional circumstances!
         (yellow-d  (get-palette-color palette "yellow-d") )
         (yellow-l  (get-palette-color palette "yellow-l") )
         (orange-d  (get-palette-color palette "orange-d") )
         (orange-l  (get-palette-color palette "orange-l") )
         (red-d     (get-palette-color palette "red-d") )
         (red-l     (get-palette-color palette "red-l") )
         (magenta-d (get-palette-color palette "magenta-d") )
         (magenta-l (get-palette-color palette "magenta-l") )
         (violet-d  (get-palette-color palette "violet-d") )
         (violet-l  (get-palette-color palette "violet-l") )
         (blue-d    (get-palette-color palette "blue-d") )
         (blue-l    (get-palette-color palette "blue-l") )
         (cyan-d    (get-palette-color palette "cyan-d") )
         (cyan-l    (get-palette-color palette "cyan-l") )
         (green-d   (get-palette-color palette "green-d") )
         (green-l   (get-palette-color palette "green-l") )
         ...
         (s-mode-line-inactive-bg (if (eq variant 'light) (if base4 base4 base0)
				    (if base4 base4 base00)))
         (s-mode-line-bg (if (eq variant 'light) (if base04 base04 base01)
                           (if base04 base04 base01)))
         (s-mode-line-box (if (eq variant 'light) (if base05 base05 base03)
			    (if base5 base5 base3)))
         (s-mode-line-fg (if (eq variant 'light) (if base6 base6 base3)
                           (if base06 base06 base3)))
         (s-mode-line-inactive-fg (if (eq variant 'light) (if base6 base6 base3)
				    (if base06 base06 base02)))
    ...
    (custom-theme-set-faces
     ...
     `(mode-line
       ((,class (:inverse-video unspecified
                                ...
                                :box (:line-width 1 :color ,s-mode-line-box
                                                  :style unspecified)))))
     ...
     ;; git-gutter
     `(git-gutter:added ((,class (:background ,solarized-bg :foreground ,green
                                              :weight bold))))
     `(git-gutter:deleted ((,class (:background ,solarized-bg :foreground ,red
                                                :weight bold))))
     `(git-gutter:modified ((,class (:background ,solarized-bg :foreground ,blue
                                                 :weight bold))))
